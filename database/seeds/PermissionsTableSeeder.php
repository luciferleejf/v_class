...
class PermissionsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Permission::create([
            'name' => 'class manage',
            'slug' => 'admin.systems.class',
            'description' => '课程管理'
        ]);


        Permission::create([
            'name' => 'Show class categories list',
            'slug' => 'admin.class.categories',
            'description' => '显示课程分类'
        ]);

        Permission::create([
            'name' => 'Show class articles list',
            'slug' => 'admin.class.articles',
            'description' => '显示课程列表'
        ]);
        ...
        Permission::create([
            ...
            'slug' => 'admin.adviser.categories',
            'description' => '显示顾问分类'
        ]);

        Permission::create([
            'name' => 'Show adviser articles list',
            'slug' => 'admin.adviser.articles',
            'description' => '显示顾问列表'
        ]);
