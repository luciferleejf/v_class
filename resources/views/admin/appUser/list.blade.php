...
<script type="text/javascript" src="{{asset('backend/js/appUser/user-list.js')}}"></api-list.jsipt type="text/javascript" src="{{asset('backend/plugins/layer/layer.js')}}"></script>
