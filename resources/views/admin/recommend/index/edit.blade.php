      ...
      <div class="portlet light bordered">
          ...
          <div class="portlet-body form">
          		@if (isset($errors) && count($errors) > 0 )
					    ...
					    @endif
              <form role="form" class="form-horizontal" method="POST" action="{{url('admin/recommend/'.$recommend['id'])}}">
              		{!! csrf_field() !!}
                  ...
                  <div class="form-body">
                          ...
                          <div class="col-md-3">
                              <div class="row fileupload-buttonbar" style="padding-left:15px;">
                                  <div class="thumbnail col-sm-10">
                                      <img id="weixin_show" style="height:150px;margin-top:10px;margin-bottom:10px;width:90%;"  @if($recommend['img']=="")src="{{url('/backend/img/upload.jpg')}}" @else src="{{$recommend['img']}}" @endif data-holder-rendered="true">
                      ...
                      <div class="form-group form-md-line-input">
                          ...
                          <div class="col-md-10">
                              <div class="md-radio-inline">
                                  <div class="md-radio">
                                      <input type="radio" id="no" name="show" value="{{config('admin.global.show.no')}}" class="md-radiobtn" @if($recommend['show']==config('admin.global.show.no')) checked @endif >
                                      <label for="no">
                                          <span></span>
                                  ...
                                  <div class="md-radio">
                                      <input type="radio" id="yes" name="show" value="{{config('admin.global.show.yes')}}" class="md-radiobtn" @if($recommend['show']==config('admin.global.show.yes')) checked @endif >
                                      <label for="yes">
                                          <span></span>
                                          <span class="check"></span>
                      ...
                      <div class="form-group form-md-line-input">
                          ...
                          <div class="col-md-8">
                              <input type="text" class="form-control" id="sort" name="sort" placeholder="{{trans('labels.recommend.sort')}}" value="{{$recommend['sort']}}">
